...
JetBrains IDEs require Java and ship their own bundled JDK - you do not need to install Java separately. Git must be installed separately; see [git/02-installing-git.md](../02-git/02-installing-git.md). JetBrains detects your system Git automatically on first launch.
