...
**Tags covered in depth:** Full Git tag coverage (annotated vs lightweight, pushing tags, signing tags) is in [git/16-tags-and-releases.md](../git/16-tags-and-releases.md).
...
GitHub Releases work best with **semantic versioning** (`MAJOR.MINOR.PATCH`). Full coverage is in [git/16-tags-and-releases.md](../git/16-tags-and-releases.md). Quick reference:
