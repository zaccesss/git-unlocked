...
*Pages templates* — each includes a working `.gitlab-ci.yml` for Pages deployment:
- Jekyll, Hugo, Gatsby, MkDocs, Middleman, Hexo, Pelican, Sphinx, Eleventy, plain HTML

*Framework/language templates* — starter projects with common structure:
- Ruby on Rails, Spring (Java), Node.js Express, Django (Python), Android, iOS (Swift), Flutter, NestJS

*GitLab-specific templates*:
