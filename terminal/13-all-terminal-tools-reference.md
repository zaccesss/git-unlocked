...
- [git/21-advanced-config.md](../git/21-advanced-config.md) - Git configuration deep dive
- [git/18-hooks.md](../git/18-hooks.md) - Git hooks for automation
- [git/12-git-workflows.md](../git/12-git-workflows.md) - Branching strategies
- [git/13-rebase.md](../git/13-rebase.md) - Rebase in depth
- [ides-and-editors/08-lazygit.md](../ides-and-editors/08-kiro.md) - lazygit in editors
