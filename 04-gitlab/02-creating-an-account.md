...
5. **Usage type**: Authentication & Signing is the recommended default. Authentication allows push/pull. Signing allows commit signing (see [git/20-signing-commits.md](../02-git/20-signing-commits.md)).
