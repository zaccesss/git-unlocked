...
You do not have write access to the original repository. You can only push to your own fork. The pull request is your way of proposing that the original maintainer merge your changes. This is covered in detail in [github/05-pull-requests.md](../github/05-pull-requests.md).
