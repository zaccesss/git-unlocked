...
SSH signing reuses your existing SSH key. If you have not set up an SSH key yet, follow the SSH setup in [introduction/03-setting-up.md](../introduction/03-setting-up.md).
