...
This file covers installing Git on Windows, Mac and Linux in full detail. If you already followed [Setting Up](../introduction/03-setting-up.md) and installed Git there, you can skip to the [Verify your installation](#verify-your-installation) section to confirm everything is working correctly.
