...
- Use GitHub and GitLab professionally
...
The single most searched question on Stack Overflow - with over 14 million views - is "How do I undo my last commit?" Developers with 10 years of experience still Google it. You are not behind. You are not slow. Git is genuinely unintuitive in places, and that is not your fault.

Here is what nobody tells you: most developers only use about 10 commands regularly. Everything else they look up as needed. The goal is not to memorise everything - it is to understand what Git is doing so you can figure out what you need when you need it.
...
Most Git tutorials give you a list of commands to memorise. This course explains the why behind everything.

| Other tutorials | git-unlocked |
|---|---|
| Commands without context | Every command explained with why and when |
...
You do not need anything installed yet. The next file - [Setting Up](03-setting-up.md) - will walk you through getting everything ready on your operating system.

If you want to know how to use this course and navigate between files, read [How to Use This Course](02-how-to-use-this-course.md) next.

If you are in a hurry and just want to get started, head straight to [What is Version Control?](../git/01-what-is-version-control.md).
...
1. [How to Use This Course](02-how-to-use-this-course.md) - learn how to navigate and get the most out of git-unlocked
2. [Setting Up](03-setting-up.md) - get Git installed and configured on your machine
3. [What is Version Control?](../git/01-what-is-version-control.md) - start the actual course
