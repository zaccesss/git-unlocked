...
- Git installed and configured ([git/02-installing-git.md](../02-git/02-installing-git.md))
- A GitHub account ([github/02-creating-an-account.md](../03-github/02-creating-an-account.md))
...
Read [introduction/03-setting-up.md](../01-introduction/03-setting-up.md) for a complete development environment setup guide.
