...
VS Code requires Git to be installed separately. See [git/02-installing-git.md](../git/02-installing-git.md) if you have not done that yet. VS Code needs Git 2.0.0 or later; the current recommended version is 2.44 or above.
